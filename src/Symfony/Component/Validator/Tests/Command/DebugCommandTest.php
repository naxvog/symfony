...
class DebugCommandTest extends TestCase
{
    public function testOutputWithClassArgument()
    {
        ...
        $this->assertSame(<<<TXT
            ...
            +---------------+----------------------------------------------------+----------------------------------------------------------------+------------------------------------------------------------+
            | -             | Symfony\Component\Validator\Constraints\Expression | Default, Symfony\Component\Validator\Tests\Dummy\DummyClassOne | [                                                          |
            |               |                                                    |                                                                |   "expression" => "1 + 1 = 2",                             |
            ...
            |               |                                                    |                                                                | ]                                                          |
            | code          | Symfony\Component\Validator\Constraints\NotBlank   | Default, Symfony\Component\Validator\Tests\Dummy\DummyClassOne | [                                                          |
            |               |                                                    |                                                                |   "allowNull" => false,                                    |
            ...
            |               |                                                    |                                                                |   "traversalStrategy" => "None"                            |
            |               |                                                    |                                                                | ]                                                          |
            | email         | Symfony\Component\Validator\Constraints\Email      | Default, Symfony\Component\Validator\Tests\Dummy\DummyClassOne | [                                                          |
    ...
    public function testOutputWithPathArgument()
    {
        ...
        $this->assertSame(<<<TXT
            ...
            | Property      | Name                                               | Groups                                                         | Options                                                    |
            +---------------+----------------------------------------------------+----------------------------------------------------------------+------------------------------------------------------------+
            | -             | Symfony\Component\Validator\Constraints\Expression | Default, Symfony\Component\Validator\Tests\Dummy\DummyClassTwo | [                                                          |
            |               |                                                    |                                                                |   "expression" => "1 + 1 = 2",                             |
            |               |                                                    |                                                                |   "message" => "This value is not valid.",                 |
            |               |                                                    |                                                                |   "negate" => true,                                        |
            |               |                                                    |                                                                |   "payload" => null,                                       |
            ...
            |               |                                                    |                                                                |   "traversalStrategy" => "None"                            |
            |               |                                                    |                                                                | ]                                                          |
            | code          | Symfony\Component\Validator\Constraints\NotBlank   | Default, Symfony\Component\Validator\Tests\Dummy\DummyClassTwo | [                                                          |
            |               |                                                    |                                                                |   "allowNull" => false,                                    |
            |               |                                                    |                                                                |   "message" => "This value should not be blank.",          |
            |               |                                                    |                                                                |   "normalizer" => null,                                    |
            |               |                                                    |                                                                |   "payload" => null                                        |
            ...
            |               |                                                    |                                                                |   "traversalStrategy" => "None"                            |
            |               |                                                    |                                                                | ]                                                          |
            | email         | Symfony\Component\Validator\Constraints\Email      | Default, Symfony\Component\Validator\Tests\Dummy\DummyClassTwo | [                                                          |
            |               |                                                    |                                                                |   "message" => "This value is not a valid email address.", |
            |               |                                                    |                                                                |   "mode" => null,                                          |
            |               |                                                    |                                                                |   "normalizer" => null,                                    |
            |               |                                                    |                                                                |   "payload" => null                                        |
